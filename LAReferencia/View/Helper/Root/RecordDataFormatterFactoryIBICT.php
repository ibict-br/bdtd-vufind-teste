 ...
 class RecordDataFormatterFactoryIBICT extends \VuFind\View\Helper\Root\RecordDataFormatterFactory
 {
    public function getDefaultCoreSpecs()
    {
        ...
        $spec->setLine(
            ...
            'Defense year', 'getPublicationDates');
        ...
        $spec->setTemplateLine(
            ...
            'Institution', 'getRootPublishers', 'data-publicationDetails.phtml'
        );
		...
		/* novos campos */
        $spec->setTemplateLine(
            'Program ID', 'getprogramIDPublishers', 'data-publicationDetails.phtml'
        );

        $spec->setTemplateLine(
            'Área de Avaliação', 'getareaavaliacaoPublishers', 'data-publicationDetails.phtml'
        );
		
        $spec->setTemplateLine(
            'Grande Área', 'getgrandeareaPublishers', 'data-publicationDetails.phtml'
        );		
